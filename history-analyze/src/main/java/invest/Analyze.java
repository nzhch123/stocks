...
public class Analyze {
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        ...
        List<List<StockHistory>> lists = new ArrayList<>();
//        for (Stock s :
//                stockList) {
...
//                lists.add(stockHistoryList);
//            }
//
//        }
        DataFactory stockHistory = new DataFactory(stockList.get(0).getSymbol());
        Object object = stockHistory.getData(DataEnum.STOCK_HISTORY);
        List<StockHistory> stockHistoryList = null;
        if (object != null) {
            stockHistoryList = (List<StockHistory>) object;
        ...
        //保存
        em.persist(stockHistoryList.get(100)); //保存操作
        //5.提交事务
        tx.commit();
        //6.释放资源
        em.close();
